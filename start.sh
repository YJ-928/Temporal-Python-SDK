...
echo -e "${BLUE}==============================================${NC}"
echo -e "${BLUE}        Initializing Workflow Platform        ${NC}"
echo -e "${BLUE}==============================================${NC}"
echo ""

# 1. Start Temporal
echo -e "${BLUE}[1/4] Starting Temporal Server...${NC}"
bash scripts/start_temporal.sh
echo ""
...
# 3. Start Agents
echo -e "${BLUE}[3/4] Starting Mock Agents...${NC}"
bash scripts/start_agents.sh
echo ""

# 4. Start Zigflow Runtime Daemon
echo -e "${BLUE}[4/4] Starting Zigflow Runtime...${NC}"
